...
fn test_seal_lifecycle_2kib_base_8() -> Result<()> {
    seal_lifecycle::<SectorShape2KiB>(SECTOR_SIZE_2_KIB, APIVersion::V1_0)?;
    seal_lifecycle::<SectorShape2KiB>(SECTOR_SIZE_2_KIB, APIVersion::V1_1)
}

#[test]
#[ignore]
fn test_seal_lifecycle_4kib_sub_8_2() -> Result<()> {
    seal_lifecycle::<SectorShape4KiB>(SECTOR_SIZE_4_KIB, APIVersion::V1_0)?;
    seal_lifecycle::<SectorShape4KiB>(SECTOR_SIZE_4_KIB, APIVersion::V1_1)
}

#[test]
#[ignore]
fn test_seal_lifecycle_16kib_sub_8_2() -> Result<()> {
    seal_lifecycle::<SectorShape16KiB>(SECTOR_SIZE_16_KIB, APIVersion::V1_0)?;
    seal_lifecycle::<SectorShape16KiB>(SECTOR_SIZE_16_KIB, APIVersion::V1_1)
}

#[test]
#[ignore]
fn test_seal_lifecycle_32kib_top_8_8_2() -> Result<()> {
    seal_lifecycle::<SectorShape32KiB>(SECTOR_SIZE_32_KIB, APIVersion::V1_0)?;
    seal_lifecycle::<SectorShape32KiB>(SECTOR_SIZE_32_KIB, APIVersion::V1_1)
}
...
//#[test]
//#[ignore]
//fn test_seal_lifecycle_512mib_top_8_0_0_v1_0() -> Result<()> {
//    seal_lifecycle::<SectorShape512MiB>(SECTOR_SIZE_512_MIB, APIVersion::V1_0)
//}

//#[test]
//#[ignore]
//fn test_seal_lifecycle_512mib_top_8_0_0_v1_1() -> Result<()> {
//    seal_lifecycle::<SectorShape512MiB>(SECTOR_SIZE_512_MIB, APIVersion::V1_1)
//}

//#[test]
//#[ignore]
//fn test_seal_lifecycle_32gib_top_8_8_0_v1_0() -> Result<()> {
//    seal_lifecycle::<SectorShape32GiB>(SECTOR_SIZE_32_GIB, APIVersion::V1_0)
//}

//#[test]
//#[ignore]
//fn test_seal_lifecycle_32gib_top_8_8_0_v_1_1() -> Result<()> {
//    seal_lifecycle::<SectorShape32GiB>(SECTOR_SIZE_32_GIB, APIVersion::V1_1)
//}

//#[test]
//#[ignore]
//fn test_seal_lifecycle_64gib_top_8_8_2_v1_0() -> Result<()> {
//    seal_lifecycle::<SectorShape64GiB>(SECTOR_SIZE_64_GIB, APIVersion::V1_0)
//}

//#[test]
//#[ignore]
//fn test_seal_lifecycle_64gib_top_8_8_2_v1_1() -> Result<()> {
...
fn seal_lifecycle<Tree: 'static + MerkleTreeTrait>(
    ...
    create_seal::<_, Tree>(rng, sector_size, prover_id, false, api_version)?;
    Ok(())
}
...
fn test_resumable_seal_skip_proofs() {
    run_resumable_seal::<SectorShape2KiB>(true, 0, APIVersion::V1_0);
    run_resumable_seal::<SectorShape2KiB>(true, 1, APIVersion::V1_0);
    run_resumable_seal::<SectorShape2KiB>(true, 0, APIVersion::V1_1);
    run_resumable_seal::<SectorShape2KiB>(true, 1, APIVersion::V1_1);
}

#[test]
#[ignore]
fn test_resumable_seal() {
    run_resumable_seal::<SectorShape2KiB>(false, 0, APIVersion::V1_0);
    run_resumable_seal::<SectorShape2KiB>(false, 1, APIVersion::V1_0);
    run_resumable_seal::<SectorShape2KiB>(false, 0, APIVersion::V1_1);
    run_resumable_seal::<SectorShape2KiB>(false, 1, APIVersion::V1_1);
}
...
fn run_resumable_seal<Tree: 'static + MerkleTreeTrait>(
    ...
    let config = porep_config(sector_size, ARBITRARY_POREP_ID, api_version);
    let ticket = rng.gen();
...
fn winning_post<Tree: 'static + MerkleTreeTrait>(
    ...
    let (sector_id, replica, comm_r, cache_dir) = if fake {
        create_fake_seal::<_, Tree>(rng, sector_size, api_version)?
    } else {
        create_seal::<_, Tree>(rng, sector_size, prover_id, true, api_version)?
    };
